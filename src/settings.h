// clang-format off
	...
	*/
	...
	constexpr const char accessPointNetworkSSID[] = "Jolibox";     // Access-point's SSID
	...
	// Bluetooth
	constexpr const char nameBluetoothSinkDevice[] = "Jolibox";        // Name of your ESPuino as Bluetooth-device
